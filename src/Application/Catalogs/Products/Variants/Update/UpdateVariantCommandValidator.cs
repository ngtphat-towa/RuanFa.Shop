...
internal class UpdateVariantCommandValidator : AbstractValidator<UpdateVariantCommand>
{
    public UpdateVariantCommandValidator()
    {
        RuleFor(x => x.VariantId)
            .NotEqual(Guid.Empty)
                .WithErrorCode(DomainErrors.ProductVariant.InvalidId.Code)
                .WithMessage(DomainErrors.ProductVariant.InvalidId.Description);
